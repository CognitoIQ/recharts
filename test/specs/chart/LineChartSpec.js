...
describe('<LineChart /> - Rendering two line charts with syncId', () => {
  ...
  it('will show tooltips for both charts synced by index on MouseEnter and hide on MouseLeave', async () => {
    const ActiveDot = ({ cx, cy }) => <circle cx={cx} cy={cy} r={10} className="customized-active-dot" />;
  ...
  it("will show tooltips using syncMethod: 'value' for both charts on MouseEnter and hide on MouseLeave", async () => {
    const ActiveDot = ({ cx, cy }) => <circle cx={cx} cy={cy} r={10} className="customized-active-dot" />;
  ...
  it('will show tooltips using syncMethod: [function] for both charts on MouseEnter and hide on MouseLeave', async () => {
    const ActiveDot = ({ cx, cy }) => <circle cx={cx} cy={cy} r={10} className="customized-active-dot" />;
